...
export const BalanceWidget = ({ uid }) => {
    ...
    useEffect(() => {
      const fetchCurrencies = async () => {
        try {
          // need to replace with the public link
          // const response = await axios.get(PUBLIC_URL/api/currency);
    ...
    return (
      <div className="IncomeExpenses">
        ...
        {balance === 0 ? (
          <button className="button balance" onClick={openAddBalanceModal}>Balance</button>
        ) : (
          ...
          <div className="modal-overlay">
            <div className="modalIncome">
              ...
              <form>
                ...
                <select id="currency-select" name="currency" value={selectedCurrency} onChange={(e) => setSelectedCurrency(e.target.value)} required >
                ...
                <select id="income-type" name="type" required value={selectedIncomeType} onChange={(e) => setSelectedIncomeType(e.target.value)}> 
                ...
                <input type="date" id="income-date" name="date" value={selectedIncomeDate} onChange={(e) => setSelectedIncomeDate(e.target.value)}
                  required />
  
                {/* Submit Button */}
                <button type="button" className="modal-button" onClick={addIncome} >
                  Add Income
                </button>
              </form>
            </div>
          ...
          <div className="modal-overlay">
            <div className="modalExpenses">
              ...
              <form>
                ...
                <select id="expenses-type" name="type" required value={selectedExpensesType} onChange={(e) => setSelectedExpensesType(e.target.value)}> 
                ...
                <input type="date" id="expenses-date" name="date" value={selectedExpensesDate} onChange={(e) => setSelectedExpensesDate(e.target.value)} required />

                {/* Submit Button */}
                <button type="button" className="modal-button" onClick={addExpenses}>
                  Add Expenses
                </button>
              </form>
            </div>
          ...
          <div className="modal-overlay">
            <div className="modalBalance">
              ...
              <form>
                ...
                {/* Submit Button */}
                <button type="button" className="modal-button" onClick={addBalance}>
                  Add Balance
                </button>
              </form>
            </div>
